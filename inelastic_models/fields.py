...
class CharField(StringField):
    ...
    def get_normalizer(self):
        return ("keyword_normalizer", {"filter": ["trim", "lowercase"]})
...
class NGramField(StringField):
    ...
    def get_analyzer(self):
        ...
        return (name, {"tokenizer": "standard", "filter": [filter_name]})
...
class FieldMappingMixin:
    ...
    def get_attr_field(self, attr):
        ...
        try:
            ...
            elif isinstance(field, (models.ForeignKey, models.IntegerField)):
